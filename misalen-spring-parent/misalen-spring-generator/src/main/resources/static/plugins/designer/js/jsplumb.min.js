(function() {
	...
	function() {
		...
		var a = this,
			...
			D = function(a, b, c) {
				...
				this.posses = [], this.posseRoles = {}, this.toGrid = function(a) {
					...
					var b = this.params.grid ? this.params.grid[0] / 2 : E ? E : i / 2,
						c = this.params.grid ? this.params.grid[1] / 2 : E ? E : j / 2;
					return H(a, this.params.grid[0], this.params.grid[1], b, c)
					...
					if(null != r) {
						...
						var c = this.params.getPosition(r),
							...
							e = this.params.grid ? this.params.grid[1] / 2 : E;
						this.params.setPosition(r, H(c, a, b, d, e))
					}
				...
				var U = function(a, b) {
					var c = null;
					if(T[a])
						for(var d = 0; d < T[a].length; d++) try {
							var e = T[a][d](b);
							null != e && (c = e)
						} catch(f) {}
					return c
				...
				this.notifyStart = function(a) {
					...
					var b;
					b = this.params.getConstrainingRectangle ? this.params.getConstrainingRectangle(r) : this.params.getSize(r.parentNode), Q = {
						w: b[0],
						h: b[1]
		...
		}, a.Katavorio.version = "0.19.3", "undefined" != typeof exports && (exports.Katavorio = a.Katavorio)
	}.call("undefined" != typeof window ? window : this),
	function() {
		var a = function(a) {
				return "[object Array]" === Object.prototype.toString.call(a)
				...
				if(c) e.unshift(arguments);
					...
					if(c = !0, !b && a[g]) {
						var k = a[g].length,
							...
							m = !1,
							n = null;
						if(!this.shouldFireEvent || this.shouldFireEvent(g, h, i))
							for(; !m && k > l && n !== !1;) {
								if(d[g]) a[g][l].apply(this, [h, i]);
								else try {
	...
	function() {
		...
		var a, b = this,
			...
			m = b.jsPlumbUIComponent = function(a) {
				...
				if(this.getDefaultType = function() {
					...
					for(var l in a.events) b.bind(l, a.events[l]);
				this.clone = function() {
		...
		var o = 0,
			...
			q = b.jsPlumbInstance = function(f) {
				this.version = "2.5.7", f && r.extend(this.Defaults, f), this.logEnabled = this.Defaults.LogEnabled, this._connectionTypes = {}, this._endpointTypes = {}, d.EventGenerator.apply(this);
				var h = this,
					i = p(),
					j = h.bind,
					l = {},
				...
				var u = null,
							...
							if(g && r.isDragSupported(a, h)) {
								...
								if(i = r.extend({}, i), r.isAlreadyDraggable(a, h)) c.force && h.initDraggable(a, i);
									...
									var j = r.dragEvents.drag,
										...
										m = !1;
									ub(e, a), i[l] = d.wrap(i[l], function() {
					...
					T = function(a, b) {
						var c = h.Defaults.EndpointType || r.Endpoint,
							d = r.extend({}, a);
						d._jsPlumb = h, d.newConnection = R, d.newEndpoint = T, d.endpointsByUUID = y, d.endpointsByElement = x, d.fireDetachEvent = bb, d.elementId = b || $(d.source);
						var e = new c(d);
						return e.id = "ep_" + J(), ub(d.elementId, d.source), r.headless || h.getDragManager().endpointAdded(d.source, b), e
					},
					U = function(a, b, c) {
						var d = x[a];
						if(d && d.length)
				...
				this.setConnectionBeingDragged = function(a) {
					...
					for(var f = [], g = d.isArray(a) || null != a.length && !d.isString(a) ? a : [a], i = 0, j = g.length; j > i; i++) {
						e.source = h.getElement(g[i]), sb(e.source);
						var k = $(e.source),
							l = T(e, k),
							m = ub(k, e.source).info.o;
				...
				var _ = [{
					...
					ab = function(a, b, c, d) {
						...
						else if(f = $(b), g = this[h.epDefs][f], f === a[h.elId]) e = null;
						else if(g)
							for(var l in g) {
						...
						return null != e && (j.detachFromConnection(a), a.endpoints[c] = e, a[h.el] = e.element, a[h.elId] = e.elementId, k[0 === c ? "newSourceId" : "newTargetId"] = e.elementId, cb(k), d || a.repaint()), k.element = b, k
					}.bind(this);
				...
				var bb = function(a, b, c) {
					...
					cb = h.fireMoveEvent = function(a, b) {
				...
				var db = "isDetachAllowed",
					eb = "beforeDetach",
					fb = "checkCondition";
				this.deleteConnection = function(a, b) {
					return null != a && (b = b || {}, b.force || d.functionChain(!0, !1, [
						[a.endpoints[0], db, [a]],
						[a.endpoints[1], db, [a]],
						[a, db, [a]],
						[h, fb, [eb, a]]
					])) ? (a.setHover(!1), bb(a, !a.pending && b.fireEvent !== !1, b.originalEvent), a.endpoints[0].detachFromConnection(a), a.endpoints[1].detachFromConnection(a), d.removeWithFunction(w, function(b) {
						return a.id === b.id
					...
					return h.batch(function() {
						for(var d = 0; b > d; d++) c += h.deleteConnection(w[0], a) ? 1 : 0
					}), c
					...
					var c = $(a),
						d = x[c];
					if(d && d.length)
						for(var e = 0, f = d.length; f > e; e++) d[e].deleteEveryConnection(b);
					return h
					...
					for(var g in b.connections) {
						...
						if(i._jsPlumb) {
							d.removeWithFunction(w, function(a) {
								return i.id === a.id
							}), bb(i, a.fireEvent === !1 ? !1 : !i.pending, a.originalEvent);
				...
				var gb = function(a, b, c, d) {
					...
					ib = function(a, b, c) {
						return function() {
							return gb(a, b, arguments, c)
						}
					},
					jb = function(a, b) {
						return function() {
							return hb(a, b, arguments)
						}
					},
					kb = function(a, b) {
						var c = [];
				...
				this.getConnections = function(a, b) {
					...
					for(var c = a.scope || h.getDefaultScope(), d = kb(c, !0), e = kb(a.source), f = kb(a.target), g = !b && d.length > 1 ? {} : [], i = function(a, c) {
							if(!b && d.length > 1) {
								var e = g[a];
						...
						lb(d, l.scope) && lb(e, m) && lb(f, n) && i(l.scope, l)
					}
					return g
				};
				var mb = function(a, b) {
					...
					ob = function(a, b) {
						...
						for(c = 0, d = f.length; d > c; c++) e[f[c]] = ib(a, f[c], b);
						for(c = 0, d = g.length; d > c; c++) e[g[c]] = jb(a, g[c]);
						return e
					},
					pb = function(a) {
						var b = ob(a, pb);
						return r.extend(b, {
							setDetachable: ib(a, "setDetachable", pb),
							setReattach: ib(a, "setReattach", pb),
							setConnector: ib(a, "setConnector", pb),
							"delete": function() {
								for(var b = 0, c = a.length; c > b; b++) h.deleteConnection(a[b])
							},
							isDetachable: jb(a, "isDetachable"),
							isReattach: jb(a, "isReattach")
						})
					},
					qb = function(a) {
						var b = ob(a, qb);
						return r.extend(b, {
							setEnabled: ib(a, "setEnabled", qb),
							setAnchor: ib(a, "setAnchor", qb),
							isEnabled: jb(a, "isEnabled"),
							deleteEveryConnection: function() {
								for(var b = 0, c = a.length; c > b; b++) a[b].deleteEveryConnection()
							},
							"delete": function() {
								for(var b = 0, c = a.length; c > b; b++) h.deleteEndpoint(a[b])
							}
						})
					};
				this.select = function(a) {
					return a = a || {}, a.scope = a.scope || "*", pb(a.connections || h.getConnections(a, !0))
				...
				this.init = function() {
					...
					v || (tb(), h.anchorManager = new b.jsPlumb.AnchorManager({
						jsPlumbInstance: h
					}), v = !0, h.fire("ready", h))
				...
				this.makeTarget = function(a, c, d) {
					...
					for(var f = e.maxConnections || -1, g = function(a) {
							...
							this.targetEndpointDefinitions[d] = this.targetEndpointDefinitions[d] || {}, sb(d), c.el._isJsPlumbGroup && null == g.rank && (g.rank = -1);
							var j = {
						...
						}.bind(this), i = a.length && a.constructor !== String ? a : [a], j = 0, k = i.length; k > j; j++) g(i[j]);
					return this
					...
					for(var j = f.maxConnections || -1, k = f.onMaxConnections, l = function(c) {
							var e = c.id,
								i = this.getElement(c.el);
							this.sourceEndpointDefinitions[e] = this.sourceEndpointDefinitions[e] || {}, sb(e);
							var l = {
							...
							var m = b.jsPlumb.dragEvents.stop,
								...
								if(3 !== a.which && 2 !== a.button) {
									...
									if(l.enabled) {
										if(e = this.getId(this.getElement(c.el)), f.filter) {
											var m = d.isString(f.filter) ? wb(a, c.el, f.filter, this, f.filterExclude) : f.filter(a, c.el);
											if(m === !1) return
										}
										var o = this.select({
											source: e
										...
										var q = b.jsPlumb.getPositionOnElement(a, i, n),
											r = {};
				...
				this.getScope = function(a) {
					return yb(a, ["sourceEndpointDefinitions", "targetEndpointDefinitions"])
				}, this.getSourceScope = function(a) {
					return yb(a, "sourceEndpointDefinitions")
				}, this.getTargetScope = function(a) {
					return yb(a, "targetEndpointDefinitions")
				}, this.setScope = function(a, b, c) {
					this.setSourceScope(a, b, c), this.setTargetScope(a, b, c)
				}, this.setSourceScope = function(a, b, c) {
					zb(a, b, "sourceEndpointDefinitions", c), this.setDragScope(a, b)
				}, this.setTargetScope = function(a, b, c) {
					zb(a, b, "targetEndpointDefinitions", c), this.setDropScope(a, b)
				...
				this.toggleSourceEnabled = function(a, b) {
					return Ab("source", a, null, !0, b), this.isSourceEnabled(a, b)
				}, this.setSourceEnabled = function(a, b, c) {
					return Ab("source", a, b, null, c)
				}, this.isSource = function(a, b) {
					return b = b || "default", Bb(a, function(a) {
					...
					return Ab("target", a, null, !0, b), this.isTargetEnabled(a, b)
				...
				this.remove = function(a, b) {
					...
					h.silently(function() {
						rb = !1, h.removeAllGroups(), h.removeGroupManager(), h.deleteEveryEndpoint(), h.unbind(), this.targetEndpointDefinitions = {}, this.sourceEndpointDefinitions = {}, w.length = 0, this.doReset && this.doReset()
					}.bind(this))
				};
				var Eb = function(a) {
				...
				this.clear = function() {
					h.select().each(Eb), h.selectEndpoints().each(Eb), x = {}, y = {}
	...
	function() {
		var a = this,
			...
			k = function(a, b, c) {
				...
				try {
					for(var d = a.classList; d.length > 0;) d.remove(d.item(0));
	...
	function() {
		...
		b.Endpoint = function(a) {
			...
			}, this.detachFrom = function(a) {
				for(var b = [], c = 0; c < this.connections.length; c++)(this.connections[c].endpoints[1] === a || this.connections[c].endpoints[0] === a) && b.push(this.connections[c]);
				for(var d = 0, e = b.length; e > d; d++) i.deleteConnection(b[0]);
				return this
	...
	function() {
		...
		c.extend(f, b.jsPlumbUIComponent, {
			...
			var c = this;
			a = a || {}, a.width = a.width || 55, a.height = a.height || 55, this.width = a.width, this.height = a.height, this._compute = function(a, b, d) {
		...
		var a = this,
			...
			z = function(a) {
				...
				a.bind("connection", function(a) {
					...
					b = this.getGroup(b), this.expandGroup(b, !0), b[c ? v : w](d, e), a.remove(b.getEl()), delete h[b.id], delete a._groups[b.id], a.fire(p, {
						group: b
					})
			...
			A = function(c, d) {
				...
				this.overrideDrop = function() {
					...
					for(var d = 0, e = E.length; e > d; d++) u.remove(E[0], a, b, !0);
