...
public class PageAddGenerator extends BaseGenerator {
	 ...
	 *            sysFormInfo
	 */
	public PageAddGenerator setSysFormInfo(SysFormInfo sysFormInfo) {
	 ...
	 *            name
	 */
	public PageAddGenerator setName(String name) {
		this.name = name;
		return this;
	}
	 ...
	 * @return
	 */
	public PageAddGenerator setPath(String path) {
		this.path = path;
		return this;
	}
	...
	public void save() throws Exception {
		...
		FileOutputStream fos = new FileOutputStream(new File(savePath + "/add.html"));
		...
		FileOutputStream fos2 = new FileOutputStream(new File(savePath + "/add.th.xml"));
