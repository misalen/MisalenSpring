...
public class PageUpdateGenerator extends BaseGenerator {
	 ...
	 *            sysFormInfo
	 */
	public PageUpdateGenerator setSysFormInfo(SysFormInfo sysFormInfo) {
	 ...
	 *            name
	 */
	public PageUpdateGenerator setName(String name) {
		this.name = name;
		return this;
	}
	 ...
	 * @return
	 */
	public PageUpdateGenerator setPath(String path) {
		this.path = path;
		return this;
	}
	...
	public void save() throws Exception {
		...
		FileOutputStream fos = new FileOutputStream(new File(savePath + "/update.html"));
		...
		FileOutputStream fos2 = new FileOutputStream(new File(savePath + "/update.th.xml"));
		template2.process(data, new OutputStreamWriter(fos2, "utf-8"));
	}
}
