...
public class OracleMetaDataDialect extends AbstractMetaDataDialect {
	...
	private static final String SQL_TABLE_SCHEMA = SQL_TABLE_BASE + "where a.owner like ? " + SQL_TABLE_VIEW
			+ " where owner like ?";

	private static final String SQL_TABLE_TABLE = SQL_TABLE_BASE + "where a.table_name like ?" + SQL_TABLE_VIEW
	...
	private static final String SQL_INDEX_SCHEMA = SQL_INDEX_BASE + "where a.table_owner like ? " + SQL_INDEX_ORDER;

	private static final String SQL_INDEX_TABLE = SQL_INDEX_BASE + "where a.table_name like ? " + SQL_INDEX_ORDER;
	...
	private static final String SQL_COLUMN_SCHEMA = SQL_COLUMN_BASE + "where a.owner like ? " + SQL_COLUMN_ORDER;

	private static final String SQL_COLUMN_TABLE = SQL_COLUMN_BASE + "where a.table_name like ? " + SQL_COLUMN_ORDER;

	private static final String SQL_COLUMN_COLUMN = SQL_COLUMN_BASE + "where a.column_name like ? " + SQL_COLUMN_ORDER;
	...
	private static final String SQL_COLUMN_TABLE_AND_COLUMN = SQL_COLUMN_BASE
			+ "where a.table_name like ? and a.column_name like ? " + SQL_COLUMN_ORDER;

	private static final String SQL_COLUMN_SCHEMA_AND_TABLE_AND_COLUMN = SQL_COLUMN_BASE
			+ "where a.owner like ? and a.table_name like ? and a.column_name like ? " + SQL_COLUMN_ORDER;
	...
	private static final String SQL_PK_SCHEMA = SQL_PK_BASE + " and c.owner like ? escape '\\' " + SQL_PK_ORDER;

	private static final String SQL_PK_TABLE = SQL_PK_BASE + " and c.table_name like ? escape '\\' " + SQL_PK_ORDER;
	...
	private static final String SQL_FK_TABLE = SQL_FK_BASE + " and p.table_name like ? " + SQL_FK_ORDER;

	private static final String SQL_FK_SCHEMA_AND_TABLE = SQL_FK_BASE + " and p.owner like ? and p.table_name like ? "
			+ SQL_FK_ORDER;
		...
		try {
			...
			return new ResultSetIterator(tableRs) {
				...
				protected Throwable handleSQLException(SQLException e) {
					...
					throw new JDBCException(databaseStructure, e);
				}
			};
	...
	public Iterator<Map<String, Object>> getIndexInfo(final String catalog, final String schema, final String table) {
		try {
			...
			return new ResultSetIterator(indexRs) {
	...
	public Iterator<Map<String, Object>> getColumns(final String catalog, final String schema, final String table,
			String column) {
		...
		try {
			...
			return new ResultSetIterator(columnRs) {
	...
	public Iterator<Map<String, Object>> getPrimaryKeys(final String catalog, final String schema, final String table) {
		...
		try {
			...
			return new ResultSetIterator(pkeyRs) {
	...
	public Iterator<Map<String, Object>> getExportedKeys(final String catalog, final String schema,
		...
		try {
			...
			return new ResultSetIterator(pExportRs) {
